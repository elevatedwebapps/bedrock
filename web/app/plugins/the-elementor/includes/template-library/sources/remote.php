...
class Source_Remote extends Source_Base {
	...
	public function get_items( $args = [] ) {
		$list = get_template_directory() . '/include/elementor/templates/list.json';
	...
	public function get_item( $template_data ) {
		return [
			...
			'thumbnail' => get_template_directory_uri() . '/include/elementor/templates/img/' . $template_data['id'] .'.jpg',
	...
	public function get_data( array $args, $context = 'display' ) {
		$item = get_template_directory() . '/include/elementor/templates/items/'. $args['template_id'] .'.json';
		$data = json_decode( file_get_contents( $item, FILE_USE_INCLUDE_PATH ), true );
